 ...
 <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">积分修改</h4>
        </div>
        <div class="panel-body panel-body-nopadding">
          
          <form class="form-horizontal form-bordered" action="/Integral/index.php/Admin/Tables/tablesEdit/id/<?php echo ($edit["id"]); ?>" method="post">
            <input name="id" type="hidden" value="<?php echo ($edit["id"]); ?>" />
            <div class="form-group">
              <label class="col-sm-3 control-label" > 学号 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["s_id"]); ?>" class="form-control" id="s_id" maxlength="11" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 姓名 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["s_name"]); ?>" class="form-control" id="s_name" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 班级 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["c_name"]); ?>" class="form-control" id="c_name" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 积分 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["sc_number"]); ?>" class="form-control" id="sc_number" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 原因 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["sc_reason"]); ?>" class="form-control" id="sc_reason" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 部室 </label>
              <div class="col-sm-6">
                <input type="text" value="<?php echo ($edit["sc_union"]); ?>" class="form-control" id="sc_union" />
              </div>
            </div>
            <!-- <div class="form-group">
        ...
        <div class="panel-footer">
			 <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				  <button type="submit" class="btn btn-primary" id="input"> 确 认 </button>&nbsp;
      ...
      <script>
          ...
          $("#input").click(function(){
          		$.ajax({
          			type:'POST',
          			url:"<?php echo U('Tables/tablesedit');?>",
          			data:{
          				's_id':$('#s_id').val(),
          				's_name':$('#s_name').val(),
                  		'c_name':$('#c_name').val(),
