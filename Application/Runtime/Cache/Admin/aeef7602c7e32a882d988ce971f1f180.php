        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="s_id" maxlength="11" />
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text"  class="form-control" id="sc_number" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 原因 </label>
              <div class="col-sm-6">
                <input type="text"  class="form-control" id="sc_reason" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label"> 部室 </label>
              <div class="col-sm-6">
                <input type="text"  class="form-control" id="sc_union" />
              </div>
            </div>
            <!-- <div class="form-group">
        ...
        <div class="panel-footer">
			 <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				  <button class="btn btn-primary" id="input"> 修 改 </button>&nbsp;
