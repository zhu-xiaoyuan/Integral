    ...
    <div class="mainpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <div class="search">
              <form id="searchForm" name="searchform" class="well form-search" action="" method="post"  onSubmit="check();" enctype="multipart/form-data" style="background-color:white;margin-top:15px;">
              ...
              <div style="float:left;">                
                <span>年级：
                  ...
                  <select name="" id="">
                    <option value="">大一 上</option>
                    <option value="">大一 下</option>
                    <option value="">大二 上</option>
                    <option value="">大二 下</option>                    
                    <option value="">大三 上</option>
                    <option value="">大三 下</option>
                  </select>
                </span>
              </div>
              <div style="float:left;">               
          ...
          <table class="table table-striped" id="table2">
              ...
              <?php if($list): if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="odd gradeX">
                      ...
                      <td class="center">
                        ...
                        <a class="btn btn-xs btn-info mr-5" href="javascript:;" data-toggle="modal" data-target="#myModal" onclick="tables(this)" data-id="<?php echo ($vo["id"]); ?>">修改</a>
          ...
          <div class="modal-body">
            <form class="form-horizontal form-bordered" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                   学号 <input type="text" name="s_id" class="form-control" id="s_id" maxlength="11" />
                  <span class="Validform_checktip"></span> 
                  <br>
                   姓名 <input type="text" name="s_name" class="form-control" id="s_name" maxlength="11"/>
                  <span class="Validform_checktip"></span>
                  <br>
                   班级 <input type="text" name="c_name" class="form-control" id="c_name"/>
                  <span class="Validform_checktip"></span>
                  <br>
                  ...
                  <span class="Validform_checktip"></span>
                  <br>
                   部室 <input type="text" name="sc_union" class="form-control" id="sc_union"/>
                  <span class="Validform_checktip"></span>
                  <br>
